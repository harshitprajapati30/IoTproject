...
#define PORT				"80"
#define API_WRITE_KEY		"SPVEA7A3J0OMKS96"
#define CHANNEL_ID			" 688641"

#define SSID				"G"
#define PASSWORD			"vinnunikki"
...
int main(void)
{
	...
	while(1)
	{
		...
		sprintf(_buffer, "GET /update?api_key=%s&field1=100", API_WRITE_KEY, Sample++);
