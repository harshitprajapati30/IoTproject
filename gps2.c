...
//Lcd4_Init();
//Lcd4_Clear();
//Lcd4_Write_String("lcd initiated");
...
_delay_ms(1000);
//Lcd4_Write_String("UTC Time: ");
get_gpstime(); /* Extract Time in UTC */
//Lcd4_Write_String(Time_Buffer);
//Lcd4_Write_String(" ");
_delay_ms(500);

//Lcd4_Write_String("Lat: ");
get_latitude(GGA_Pointers[0]); /* Extract Latitude */
//Lcd4_Write_String(degrees_buffer); /* display latitude in degree */
memset(degrees_buffer,0,degrees_buffer_size);
_delay_ms(500);

//Lcd4_Write_String("Long: ");
get_longitude(GGA_Pointers[2]); /* Extract Longitude */
//Lcd4_Write_String(degrees_buffer); /* display longitude in degree */
memset(degrees_buffer,0,degrees_buffer_size);
_delay_ms(500);

//Lcd4_Write_String("Alt: ");
get_altitude(GGA_Pointers[7]); /* Extract Altitude in meters*/
//Lcd4_Write_String(Altitude_Buffer);
_delay_ms(500);
}
return 0;
}
